...
if ($_SERVER["REQUEST_METHOD"] == 'POST'){
    ...
    if (trim($name) == "" || $email == "" || $category == "" || $title == "") {
    ...
    if (!isset($error_message)) {
        ...
        $mail->Username = "nallyconnor@gmail.com";
        //Password to use for SMTP authentication
        $mail->Password = "vtoqhuioljhiimxv";

        //It's important not to use the submitter's address as the from address as it's forgery,
        //which will cause your messages to fail SPF checks.
        //Use an address in your own domain as the from address, put the submitter's address in a reply-to
        $mail->setFrom('nallyconnor@gmail.com', $name);
        $mail->addReplyTo($email, $name);
        $mail->addAddress('nallyconnor@gmail.com' , 'Connor Nally');
...
$pageTitle = "Suggent a Media Item";
$section = "suggest";
    ...
    <div class="wrapper">
        ...
        <?php if (isset($_GET["status"]) && $_GET["status"] == "thanks") {
            ...
            if (isset($error_message)) {
                ...
                echo '<p>If you think there is something I&rsquo;m missing, let me know! Complete the form to send me 
                an email.</p>';
            }
            ?>
        <form method="post" action="suggest.php">
            ...
            <tr>
                <th><label for="details">Suggest Additional Details</label></th>
            ...
            <tr style="display:none">
                ...
                <p>Please leave this field black.</p></td>
            </tr>
            </table>
